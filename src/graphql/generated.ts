...
export type GetLessonsQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLessonsQueryQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, availableAt?: any | null, title: string, slug?: string | null }> };
...
export const GetLessonsQueryDocument = gql`
...
/**
 * __useGetLessonsQueryQuery__
 *
 * To run a query within a React component, call `useGetLessonsQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonsQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonsQueryQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetLessonsQueryQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonsQueryQuery, GetLessonsQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonsQueryQuery, GetLessonsQueryQueryVariables>(GetLessonsQueryDocument, options);
      }
export function useGetLessonsQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonsQueryQuery, GetLessonsQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonsQueryQuery, GetLessonsQueryQueryVariables>(GetLessonsQueryDocument, options);
        }
export type GetLessonsQueryQueryHookResult = ReturnType<typeof useGetLessonsQueryQuery>;
export type GetLessonsQueryLazyQueryHookResult = ReturnType<typeof useGetLessonsQueryLazyQuery>;
export type GetLessonsQueryQueryResult = Apollo.QueryResult<GetLessonsQueryQuery, GetLessonsQueryQueryVariables>;